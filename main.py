...
parser.add_argument('--input_dir', type=str, help='Path to low resolution image directory.')
parser.add_argument('--input_size', default=96, type=int, help='Input size.')

parser.add_argument('--target_dir', type=str, help='Path to the Target image directory.')
parser.add_argument('--target_size', default=96, type=int, help='Target size.')

parser.add_argument('--batch_size', default=40, type=int, help='Batch size for training.')
parser.add_argument('--epochs', default=1200, type=int, help='Number of epochs for training')
parser.add_argument('--lr', default=5e-5, type=float, help='Learning rate for optimizers.')
parser.add_argument('--save_iter', default=100, type=int, help='The number of iterations to save the tensorboard summaries and models.')
...
def main():
    ...
    ds = DataLoader(args.input_dir, args.target_dir, args.input_size, args.target_size).dataset(args.batch_size)
    print("DataLoader finished")

    # Initialize the GAN object.
    gan = FastSRGAN(args)
    print("GAM object initialized")
