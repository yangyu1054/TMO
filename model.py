...
class FastSRGAN(object):
    ...
    def __init__(self, args):
        ...
        Returns:
            None
        """
        self.hr_height = args.target_size
        self.hr_width = args.target_size
        self.lr_height = args.input_size  # Low resolution height
        self.lr_width = args.input_size    # Low resolution width
        ...
        self.disc_schedule = keras.optimizers.schedules.ExponentialDecay(
            args.lr * 4,  # TTUR - Two Time Scale Updates
            decay_steps=10000,
            decay_rate=0.3,
            staircase=True
        )
    ...
    def build_generator(self):
        ...
        # Upsampling
        #u1 = deconv2d(c2)  #removed
        #u2 = deconv2d(u1)  #removed

        # Generate high resolution outputs    #changed arrow (next layer) from u2 to c2
